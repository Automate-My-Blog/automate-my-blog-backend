...
async function fixDatabaseFunction() {
  try {
    console.log('🔧 Fixing get_organization_decision_makers function...');
    
    // Drop and recreate the function with correct GROUP BY
    await db.query(`
    ...
    console.log('✅ Fixed get_organization_decision_makers function');
