...
Reserved for **API endpoint and database** tests, per [Testing Strategy](../../docs/reference/testing-strategy.md).
...
**Requirements:** Test database (separate from prod), app bootstrap, and optionally `supertest` (or similar) for HTTP. See [docs/reference/testing-strategy.md](../../docs/reference/testing-strategy.md) Implementation Plan.
