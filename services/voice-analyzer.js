...
- structural_patterns: object with opening_hook_type (e.g. anecdote, question, statistic, quote), section_organization, transition_phrases (array or description), evidence_style (how facts/claims are presented: e.g. "concrete milestones", "numbers", "statistics", "achievements"), conclusion_type (e.g. "personal sign-off", "summary", "CTA"), personal_sign_off (boolean or description if author signs with name)
