  ...
  "scenarios": [
    {
      ...
      "pitch": "REQUIRED: Single text string only (NOT an object). Start with 'If you' or 'When you' and explain the content strategy. Include: (1) What content to create referencing their seoKeywords, (2) The SEO mechanism: your blog appears in Google → they click → land on site → read expert content, (3) Why they convert based on psychographics emotional need + searchBehavior urgency → conversionPath. Example: 'If you create blog posts on safe antidepressants during pregnancy, you'll capture these Google searches when overwhelmed mothers desperately seek clinical guidance - they click to your site for expert medication advice, and their urgent anxiety converts into consultation bookings.' Plain text string. Max 380 chars.",
      "targetSegment": {
