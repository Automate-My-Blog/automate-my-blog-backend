  ...
  "scenarios": [
    {
      ...
      "pitch": "REQUIRED: Single text string with conversion math. Structure: (1) Content to create on seoKeywords, (2) METRICS: If you capture X% of searchVolume monthly searches → that's Y clicks/month → at Z% conversion rate based on their urgency/conversionPotential → that's N consultations/bookings per month, (3) Why conversion rate is realistic given psychographics emotional state + searchBehavior. Example: 'If you create blog posts on safe antidepressants during pregnancy and capture 3% of the 3,500 monthly searches, that's 105 clicks to your site. Given their overwhelming anxiety and urgent need, a 15% consultation rate means 15 new patient bookings monthly.' Include actual numbers. Plain text string. Max 400 chars.",
      "targetSegment": {
