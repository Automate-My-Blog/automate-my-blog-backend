  ...
  "scenarios": [
    {
      ...
      "pitch": "CRITICAL: EVERY pitch MUST include conversion math AND realistic timeline expectations. MANDATORY: (1) Convey that results build over time with consistent content (use natural language, NOT templates), (2) Reference building SEO authority/rankings gradually, (3) CALCULATE NUMBERS: If capture [X%] of [exact searchVolume number] monthly searches = [Y clicks calculated], at [Z%] conversion rate = [N bookings calculated], (4) Justify conversion rate with psychographics emotional urgency. Example: 'Creating targeted content on safe antidepressants during pregnancy builds your SEO presence to eventually capture 3% of 3,500 monthly searches - that's 105 clicks. Their urgent medication anxiety means 15% consultation rate, yielding 15 bookings monthly once ranked.' Realistic expectations. CALCULATE. Vary language. Plain text. Max 420 chars.",
      "targetSegment": {
