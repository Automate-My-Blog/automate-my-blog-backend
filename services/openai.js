  ...
  "scenarios": [
    {
      ...
      "pitch": "REQUIRED: Explain the SEO content opportunity AND connect strategic dots. Include: (1) WHO + WHAT they search - demographics + exact seoKeywords (e.g., 'First-time mothers 25-35 typing safe antidepressants during pregnancy into Google'), (2) VOLUME (exact searchVolume/month), (3) THE FLOW - When you create blog post on this topic → Google shows it in search results → they click → land on your site → read your expert content → conversionPath (e.g., 'book consultation'). (4) WHY IT WORKS - content gap + their emotional state from psychographics. Connect the dots between their anxiety, search behavior, market gap, and your business opportunity. Max 420 chars.",
      "targetSegment": {
