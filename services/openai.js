  ...
  "scenarios": [
    {
      ...
      "pitch": "REQUIRED: Structure in 3 clear parts. PART 1 - THE AUDIENCE: Start with demographics + emotional state + what they're searching for (e.g., 'Pregnant women 25-35 seeking reassurance about medication safety are searching for safe antidepressants during pregnancy'). PART 2 - TRAFFIC VOLUME: Add exact searchVolume in parentheses as subtext (e.g., '(3,500 monthly searches)'). PART 3 - YOUR STRATEGY: Explain the opportunity using 'If you' or 'When you' (e.g., 'If you create blog posts addressing their medication fears, you'll capture these searches in Google, they'll click to your site for expert guidance, and their urgent anxiety converts them into consultation bookings'). Connect their emotional need to conversion outcome. Max 420 chars.",
      "targetSegment": {
