  ...
  "scenarios": [
    {
      ...
      "pitch": "CRITICAL: START with revenue opportunity, THEN explain assumptions with behavioral reasoning. FORMAT: 'Potential monthly revenue: $[low]-$[high] at $[price]/session ([X-Y] consultations). This assumes over 6-12 months your SEO builds to capture [A-B%] of [searchVolume] monthly searches for [audience] on [seoKeywords], leading to [C-D] site visits with [E-F%] engagement rate (bounce rate [G-H%]), and [I-J%] CTA conversion based on their [psychographics urgency] and [searchBehavior pattern]. Example values justify assumptions.' Example: 'Potential revenue: $4,000-$17,500/month at $500/session (8-35 consultations). Assumes over 6-12 months your SEO captures 2-5% of 3,500 monthly searches from anxious pregnant women seeking safe medication guidance, generating 70-175 visits with 60-80% engagement (20-40% bounce) because they're desperately seeking clinical answers, and 15-25% book consultations due to crisis-driven urgency.' Lead with ROI. Justify with behavior. Max 550 chars.",
      "targetSegment": {
