  ...
  "scenarios": [
    {
      ...
      "pitch": "REQUIRED: Synthesize ALL the data below into a strategic pitch. MUST reference: (1) Specific demographics + their exact seoKeywords searches (e.g., 'First-time mothers 25-35 searching for safe antidepressants during pregnancy'), (2) Their emotional state from psychographics (e.g., 'overwhelmed and seeking reassurance'), (3) Exact searchVolume number, (4) Their searchBehavior pattern (e.g., 'crisis-driven searches during pregnancy stress'), (5) Content gap + why they'll convert to conversionPath (e.g., 'most content lacks clinical guidance, so educational posts position you as trusted expert for consultations'). Connect the dots between their anxiety, search behavior, market gap, and your business opportunity. Max 380 chars.",
      "targetSegment": {
