  ...
  "scenarios": [
    {
      ...
      "pitch": "CRITICAL: Show full funnel with RANGES and conditional IF statements (never commit to numbers). FORMAT: 'IF you create content on [seoKeywords] and IF your posts capture [X-Y%] of [searchVolume] monthly searches, that's [A-B clicks]. IF [M-N%] engage with content and IF [P-Q%] click CTAs, you could see [low-high range] consultations monthly - potentially $[low]-[high] monthly revenue at $[reasonable price] per service. This assumes: SEO builds over months, compelling content reduces bounce rate, strong CTAs, and [psychographics urgency] drives action.' Example: 'IF you create content on safe pregnancy medications and IF you capture 2-5% of 3,500 searches (70-175 clicks), and IF 60-80% engage with 15-25% CTA clicks, you could see 8-35 consultations monthly - potentially $4,000-$17,500/month at $500/session. This assumes SEO authority builds over time, engaging content, and urgent anxiety drives bookings.' Show ranges. Emphasize assumptions. Max 520 chars.",
      "targetSegment": {
